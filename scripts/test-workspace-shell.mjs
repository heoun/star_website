...
for(const [identity,routes] of [[{role:'agent'},['applications','listings']],[{role:'manager'},['applications','onboarding','properties','listings','staff','requests']],[{role:'landlord'},['overview','properties','leases']],[{role:'manager',owner:true},['staff']]]){
