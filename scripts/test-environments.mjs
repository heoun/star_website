...
const DB={prepare(sql){return {bind(...args){const q=db.prepare(sql);return {async first(){return q.get(...args)},async run(){return q.run(...args)},async all(){return q.all(...args)}}},async all(){return db.prepare(sql).all()}}}};
