...
const selectors = '.rg-fact > span,.cw-review-fact .k,.cw-proof > span,.prop-mobile-caption,.prop-listing-count,.prop-signer-label,dt,label,[data-setting-row] > .lbl,.prop-row.is-head > span:not(:empty),.desk-table th,.case-facts .k,.stat .k,.line > .lbl,.line > .k,.docrow > div:first-child > b';
