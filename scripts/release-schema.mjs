...
export const schemaFiles=['schema','backoffice','workspace','administration','identity','storage','property-create','rental-flow','rental-membership','rental-drafts','rental-signing','account-security','applicant-auth'];
