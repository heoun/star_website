...
const copyTargets = ["index.html", "buy", "rental", "commercial", "listings", "new-development", "contact-us", "our-team", "property", "apply", "portal", "admin", "jpg", "png", "data", "shared", "favicon.ico", "favicon.svg", "apple-touch-icon.png"];
