...
export const PROPERTY_SECTIONS = [
  ...
  { id: "management", label: "Management & Notices", note: "Set management, notice recipients and the housing emergency contact.", ids: ["manager.name", "manager.contact_name", "manager.email", "manager.address", "manager.phone", "legal_notice.name", "legal_notice.address", "legal_notice.phone", "emergency.phone"] },
