...
export function testSteps(app,complete) {
  ...
  const notification={sent:'Email Submitted / Awaiting Decision',failed:'Email Not Sent — Delivery Failed',preview:'Email Preview Only — Not Sent',sending:'Sending Landlord Email',pending:'Landlord Email Pending'}[app.landlord_email_status] || 'Landlord Email Pending';
